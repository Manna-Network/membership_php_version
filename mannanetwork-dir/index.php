...
include($_SERVER['DOCUMENT_ROOT']."/mannanetwork-dir/js/registration.js");
include($_SERVER['DOCUMENT_ROOT']."/mannanetwork-dir/translations/en.js"); 
$lnk_num = 1; 
...
echo '<div style="font-size:24px; width: 700px ;
  margin-left: auto ;
...
$display_main .= "<div style='font-size:24px; width: 700px ;
  margin-left: auto ;
